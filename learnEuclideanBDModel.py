# -*- coding: utf-8 -*-
"""
Euclidean Bin and Delta model for the axis-angle representation
"""
...
parser = argparse.ArgumentParser(description='Euclidean Bin & Delta Model')
