...
from dataGenerators import Pascal3dAll, my_collate, ImagesAll
from quaternion import get_error2, geodesic_loss, model_3layer
...
# DATA
# datasets
real_data = ImagesAll(args.augmented_path, 'real', 'quaternion')
render_data = ImagesAll(args.render_path, 'render', 'quaternion')
...
class RegresionModel(nn.Module):
	def __init__(self):
		...
		self.pose_models = nn.ModuleList([model_3layer(args.N0, args.N1, args.N2) for i in range(self.num_classes)]).cuda()
