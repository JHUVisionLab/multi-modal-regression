...
from binDeltaModels import bin_3layer, res_2layer, loss_m4
...
# save stuff here
save_str = 'resnet50_2layer_multires_m3_1'
...
problem_type = 'm3'
criterion = loss_m4(1.0, kmeans_file, geodesic_loss(reduce=False).cuda())
